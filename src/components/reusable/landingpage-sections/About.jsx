    ...
    return ( 
        <div className="px-5 md:px-24 mb-20 w-full relative">
           ...
           <div className='flex flex-col text-center lg:text-left lg:w-4/5 space-y-5'>
                ...
                <p>
                We have highly trained and qualified tutors that hold the hands of 
                our students and walk them through their journey in any of their 
                chosen course. We give you the best at Edu_cate.
                </p>
            </div>
